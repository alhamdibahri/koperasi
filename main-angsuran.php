        ...
        <div class="col-md-12">
          <div class="box box-info">
            ...
            <div class="box-body pad" style="display: block;">
				...
				include'koneksi.php';
				include'funct.php';
				$sql = mysql_query("SELECT * FROM angsuran order by id_angsuran");
			?>
            ...
            <?php 
				$jum_ang_pendek = mysql_query("SELECT * FROM angsuran WHERE nama_pinjaman='Pinjaman Jangka Pendek' AND id_anggota='".$data['id_anggota']."'");
				$num1 = mysql_num_rows($jum_ang_pendek);
				$jum_ang_menengah = mysql_query("SELECT * FROM angsuran WHERE nama_pinjaman='Pinjaman Jangka Menengah' AND id_anggota='".$data['id_anggota']."'");
				$jum_ang_panjang = mysql_query("SELECT * FROM angsuran WHERE nama_pinjaman='Pinjaman Jangka Panjang' AND id_anggota='".$data['id_anggota']."'");
				$num1 = mysql_num_rows($jum_ang_pendek);
				$num2 = mysql_num_rows($jum_ang_menengah);
				$num3 = mysql_num_rows($jum_ang_panjang);
				$pinjaman = mysql_query("SELECT * FROM pinjaman WHERE id_anggota='".$data['id_anggota']."'");
				$data_pinjaman = mysql_fetch_array($pinjaman);
				if ($num1 == 10)
				{
