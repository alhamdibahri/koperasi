...
if(isset($_GET['reqa']) && $_GET['reqa'] == 'edit'){
	...
	$query 			= mysql_query("select * from anggota a , k_simpanan b where a.id_anggota='".$id_anggota."' AND b.id='1'");
	...
	$carikode = mysql_query("select max(id_anggota) from anggota") or die (mysql_error());
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="j_kel" >
                  	<option selected value="">PILIH JENIS KELAMIN ANDA</option>
