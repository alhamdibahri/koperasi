  ...
  <section class="invoice">
    ...
    <h3 class="text-center">Laporan Simpanan</h3>
      ...
      <?php 
	  	include 'koneksi.php'; 
		include'funct.php';
		$sql = mysql_query("SELECT a.nama,s.id_anggota,s.nm_simpanan,s.tgl_simpanan,s.besar_simpanan AS total FROM simpanan s,anggota a WHERE a.id_anggota=s.id_anggota AND bln='".$_GET['bln']."'");
		$no = 1;
	  ?>
        <table class="table table-striped table-bordered">
          ...
          <tr>
          <?php 
		  $query = mysql_query("SELECT a.nama,s.id_anggota,s.nm_simpanan,s.tgl_simpanan,SUM(s.besar_simpanan) AS total FROM simpanan s,anggota a WHERE a.id_anggota=s.id_anggota AND bln='".$_GET['bln']."'");
