...
if(isset($_GET['reqang']) && $_GET['reqang'] == 'add')
{
	...
	$carikode = mysql_query("select max(id_angsuran) from angsuran") or die (mysql_error());
           ...
           <input type="hidden" name="id_angsuran" value="<?php echo $id_angsuran ?>">
              ...
              <div class="form-group">
                ...
                <select class="form-control select2 select2-hidden-accessible" style="width: 100%;" tabindex="-1" aria-hidden="false" name="id_pinjaman" id="id_pinjaman">
                  ...
                  <?php
				  $sql = mysql_query("SELECT * FROM pinjaman WHERE ket='0' AND NOT bln='".$s."' OR NOT thn='".$t."'");
                  ...
                  <option 
                    ...
                    angsuran_ke="<?php 
						$gg = mysql_query("SELECT max(angsuran_ke) AS angsuran_ke FROM angsuran WHERE id_anggota='".$r['id_anggota']."' AND nama_pinjaman='".$r['nama_pinjaman']."'");
						$data1 = mysql_fetch_array($gg);
                    ...
                    tgl_jatuh_tempo="<?php 
						...
						$gg1 = mysql_query("SELECT tgl_acc_pinjaman,bln FROM pinjaman WHERE id_anggota='".$r['id_anggota']."' AND tgl_acc_pinjaman='".$r['tgl_acc_pinjaman']."'");
						$data2 = mysql_fetch_array($gg1);
						if ($r['nama_pinjaman'] == 'Pinjaman Jangka Pendek')
						{
