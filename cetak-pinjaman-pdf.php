  ...
  <section class="invoice">
    ...
    <h3><center><strong>Data Pinjaman</strong></center></h3>
      ...
      <?php 
	  	include 'koneksi.php'; 
		include'funct.php';
		$sql = mysql_query("SELECT p.id_pinjaman,p.nama_pinjaman,p.besar_pinjaman,p.tgl_pinjaman,p.tgl_pelunasan,a.nama FROM pinjaman p,anggota a WHERE a.id_anggota=p.id_anggota AND bln='".$_GET['bln']."'");
		$no = 1;
	  ?>
