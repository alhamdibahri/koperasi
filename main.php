    ...
    <div class="row">
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-aqua">
            ...
            <?php include 'koneksi.php'; 
				$query = mysql_query("SELECT * FROM simpanan");
				$jum_simpanan = mysql_num_rows($query);
			?>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            ...
            <?php
				...
				$jum_anggota = mysql_num_rows($query);
			?>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            ...
            <?php 
				...
				$jum_petugas = mysql_num_rows($query);
			?>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              <?php
				$query = mysql_query("SELECT * FROM pinjaman");
				$jum_peminjam = mysql_num_rows($query);
			?>
