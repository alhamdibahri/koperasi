...
<?php session_start();
  ...
  <!-- User name -->
  <div class="lockscreen-name">Alhamdi Ferdiawan Bahri</div>

  <!-- START LOCK SCREEN ITEM -->
  <div class="lockscreen-item">
    <!-- lockscreen image -->
    <div class="lockscreen-image">
      <img src="dist/img/1.JPG" alt="User Image">
    </div>
    <!-- /.lockscreen-image -->
  ...
  <div class="lockscreen-footer text-center">
    Copyright &copy; 2017 <b>Kelompok 1</b><br>
    All rights reserved
  </div>
</div>
<!-- /.center -->
